...
if __name__ == "__main__":
    if float(sys.argv[1]) == 0 :
        oint_client(0.5,0.5,0.2,1,1,1,5,'linear')
        #time.sleep(float(sys.argv[1]))
        oint_client(-0.5,0.5,0.3,1,1,1,5,'linear')
        #time.sleep(float(sys.argv[1]))
        oint_client(-0.5,-0.5,0.1,1,1,1,5,'linear')
        #time.sleep(float(sys.argv[1]))
        oint_client(0.5,-0.5,0.0,1,1,1,5,'linear')
        #time.sleep(float(sys.argv[1]))
        oint_client(0.5,0.5,0.2,1,1,1,5,'linear')
        #time.sleep(float(sys.argv[1]))
    else :
        for i in range(200) :
            oint_client(0.6*cos(i*0.05),0.2*sin(i*0.05),0.3,1,1,1,0.1,'linear')
