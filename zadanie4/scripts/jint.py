...
def handle_interpolation(req):
    ...
    if (req.j1>3.1 or req.j1<-3.1 or req.j2>3 or req.j2<-3 or req.grip>0.3 or req.grip<0):
    ...
    while k<=kkonc:
        ...
        pub2.publish(joint2)
        pub3=rospy.Publisher('gripper',Float64,queue_size=10)
        pub3.publish(gripper)
